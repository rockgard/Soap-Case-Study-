 ...
 * 
 */
@WebServiceClient(name = "ProductServiceImplService", targetNamespace = "http://prodsvc.training.com", wsdlLocation = "http://localhost:8181/Product-WebService/services/ProductServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICEIMPLSERVICE_QNAME = new QName("http://prodsvc.training.com", "ProductServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8181/Product-WebService/services/ProductServiceImpl?wsdl");
    ...
    public ProductServiceImpl getProductServiceImpl() {
        return super.getPort(new QName("http://prodsvc.training.com", "ProductServiceImpl"), ProductServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductServiceImpl")
    public ProductServiceImpl getProductServiceImpl(WebServiceFeature... features) {
        return super.getPort(new QName("http://prodsvc.training.com", "ProductServiceImpl"), ProductServiceImpl.class, features);
    }
